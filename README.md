...
|---|---|---|
| [Autonomy Log Triage](https://github.com/Parth-Oza/autonomy-log-triage) | Deterministic incident detection, severity classification, and heartbeat-gap analysis for synthetic robot events | Unit tests + CI |
| [EKF Sensor Fusion Lab](https://github.com/Parth-Oza/ekf-sensor-fusion-lab) | Transparent 2D state estimation, asynchronous updates, Joseph-form covariance, and seeded simulation | Unit tests + CI |
| [Robot Fleet Observability](https://github.com/Parth-Oza/robot-fleet-observability) | Explainable fleet-health scoring and a dependency-free read-only telemetry API | Unit tests + CI |
...
- [Speech Emotion Detection](https://github.com/Parth-Oza/SPEECH-EMOTION-DETECTION-USING-CNN-AND-LSTM) — MFCC-based speech classification with CNN and LSTM models.
- [Freight Document Agent](https://github.com/Parth-Oza/freight-doc-agent) — traceable extraction of structured freight information.
